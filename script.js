...
//     if(player0.classList.contains('player--winner') || player1.classList.contains('player--winner')){
//         dice.style.display = 'none';
//     }
...
//             buttonHold.removeEventListener('click', function(){});
//             buttonRoll.removeEventListener('click', function(){});
//         }
//     }else if(player1.classList.contains('player--active')){
